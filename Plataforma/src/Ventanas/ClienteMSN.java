 ...
 * @author Chuy
 */
public class ClienteMSN extends javax.swing.JFrame {

    /**
     * Creates new form ClienteMSN
     */
    public ClienteMSN() {
        initComponents();
    }
    ...
    public static void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteMSN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClienteMSN().setVisible(true);
            }
        });
    }
